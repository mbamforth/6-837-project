...
namespace
{
    ...
    // helps designate what kind of system it is for keyboard inputs
    bool pend;
    bool cloth;

    // remembers which particles are toggled on
  ...
  void drawSystem()
  {
    ...
    // this makes sure the plane renders correctly
    glBegin(GL_POLYGON);
    glEnd();
